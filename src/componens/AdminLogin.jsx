    ...
    <div className="bg-gray-900 text-gray-100 min-h-screen font-inter">
      <div className="max-w-6xl mx-auto px-4 md:px-8 py-8">
        <section className="bg-black border border-gray-600 rounded-xl p-6 md:p-10 shadow-xl transition-transform transform hover:-translate-y-1 hover:shadow-2xl">
          <h2 className="text-2xl sm:text-3xl font-bold text-white border-b-2 border-purple-500 pb-2 mb-6 drop-shadow">
          ...
          <ol className="list-decimal list-inside space-y-4 text-gray-300 pl-4">
            ...
            <li>
              <strong>Enter Your Details:</strong> Fill in the required information such as your full name(eg.Jeswitha ), email
              address(eg.jeswitha@gmail.com), and desired password. Ensure the email address is accurate as it will be used for verification.
            </li>

            <li>
              <strong>Clinic Information:</strong> Provide essential details about your clinic, including its
              name(eg.Jeswitha Hospital), address(), and contact information.
            </li>
            ...
            <li>
              ...
              <div className="mt-4 flex justify-center p-2 bg-black rounded-lg">
                <img
                  ...
                  className="w-full max-w-2xl h-auto rounded-lg border border-gray-600 shadow-md"
                />
              </div>
            

            <li>
              <strong>Login to Dashboard:</strong> Once verified in Mail, you can log in using your registered
              email and password to access the Admin Dashboard.
            </li>

            
              <div className="w-full max-w-3xl mx-auto mt-6 p-[2px] bg-gradient-to-r from-purple-200 to-indigo-600 rounded-lg overflow-hidden">
                <video
                  src={DashboardVid}
                  autoPlay
                  muted
